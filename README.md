...
To run any of these scripts (except for weight_problem.py) for a bacterial family, 4nes.py needs to be run first as it generates files necessary for the other scripts.
